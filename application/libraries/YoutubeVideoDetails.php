...
class YoutubeVideoDetails
{
	...
	public function get_thumbnail()
	{
		if(!$this->video)
		{
			...
			return $this->video->entry->{'media$group'}->{'media$thumbnail'}[0]->url;
		}
	}
	...
	public function get_embed($width,$height)
	{
		if(!$this->video)
		{
			...
			return '<iframe id="ytplayer" width="'.$width.'" height="'.$height.'" src="http://www.youtube.com/embed/'.$this->video_id.'" frameborder="0" allowfullscreen></iframe>';
		}
	}
}
?>