...
<h1>Search Results ("<?php echo $content['q'];?>") - <?php echo $content['total'];?> Results</h1><?php if(count($content['listings'])==0){?>
<div class="center-align center abovePadding20">No matching ads found! <br /> <?php echo anchor('classifieds/add','Post a new ad free!');?></div>
<?php }else{
	if(count($content['categories'])>0)	
	{
		...
		{
			echo "<li>".anchor('classifieds/listings/'.$cat['id'],$cat['name'])."</li>";
		}
		echo "</ul>";
	}
?>
