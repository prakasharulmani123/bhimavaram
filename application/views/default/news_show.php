...
<div id="listing-details span13"><h1 class="noline"><?php echo $content['news']['title'];?>
</h1>
    <div class="ad-meta">
...
$img='<img src="'.$this->settings->baseUrl().'/uploads/thumb/'.$newpic.'" alt="'.$listing['title'].'" class="pull-left" />';
