...
<div class="">
        ...
        <?php }
		echo form_open_multipart('admin/numbers/addnumber',array('class'=>'form-horizontal center','data-validate'=>'parsley'));?>
        <div class="control-group">
<label class="control-label" for="inputName">City</label>
<div class="controls">

<?php 
echo $this->html->formField('dropdown','cityid-required',cityArray(),array('id'=>'city','class'=>'span6 offset1 city-select','data-required'=>"true"),'');
?></div>
...
<div class="clearbig">&nbsp;</div>
      <button type="submit" class="btn btn-danger center-align span6 submit-btn" style="margin-left: 230px;">Submit</button>  
